...
import com.example.hostelnepal.databinding.ActivityHostelListForAvailabilityBinding;
...
public class HostelListForAvailabilityActivity extends AppCompatActivity {

    ActivityHostelListForAvailabilityBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= ActivityHostelListForAvailabilityBinding.inflate(getLayoutInflater());
    ...
    private void setRecyclerView() {
        ...
        adapter.setOnClickListener(new ViewPropertyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent intent = new Intent(HostelListForAvailabilityActivity.this, AvailabilityDetailsActivity.class);
